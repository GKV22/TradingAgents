...
def test_buy_candidate_valid():
    c = BuyCandidate(ticker="NVDA", company="Nvidia", buy_point="153.20", rs_rating=97, composite_rating=98, rationale="Breaking out. Strong earnings.")
...
def make_valid_digest(**overrides):
    defaults = dict(date="2026-05-19", market_pulse="Confirmed Uptrend", distribution_days=2, buy_candidates=[], stocks_to_watch=[], avoid_extended=[])
